...
# The following reads the variables without doing an "import turf",
...
version = {}
with open(path.join(here, 'turf/__version__.py')) as f:
...
setup(
    ...
    long_description = 'Turf is a program to download records from the Caltech TIND.io database and check the URLs that may be embedded within the records.',
    version          = version['__version__'],
    url              = version['__url__'],
    author           = version['__author__'],
    author_email     = version['__email__'],
    license          = version['__license__'],
    keywords         = "TIND MARC library-catalogues",
    packages         = ['turf'],
    scripts          = ['bin/turf'],
